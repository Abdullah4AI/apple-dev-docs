...
func PublishCommand() *ffcli.Command {
	return &ffcli.Command{
		Name:       "publish",
		ShortUsage: "appstore publish <subcommand> [flags]",
...
Examples:
  appstore publish testflight --app APP_ID --ipa app.ipa --group GROUP_ID
  appstore publish appstore --app APP_ID --ipa app.ipa --version 1.2.3 --submit --confirm`,
...
func PublishTestFlightCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "testflight",
		ShortUsage: "appstore publish testflight [flags]",
...
Examples:
  appstore publish testflight --app "123" --ipa app.ipa --group "GROUP_ID"
  appstore publish testflight --app "123" --ipa app.ipa --group "External Testers"
  appstore publish testflight --app "123" --ipa app.ipa --group "G1,G2" --wait --notify
  appstore publish testflight --app "123" --ipa app.ipa --group "GROUP_ID" --test-notes "Test instructions" --locale "en-US" --wait`,
		FlagSet:   fs,
		UsageFunc: shared.DefaultUsageFunc,
		Exec: func(ctx context.Context, args []string) error {
...
func PublishAppStoreCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "appstore",
		ShortUsage: "appstore publish appstore [flags]",
...
Examples:
  appstore publish appstore --app "123" --ipa app.ipa --version 1.2.3
  appstore publish appstore --app "123" --ipa app.ipa --version 1.2.3 --submit --confirm`,
		FlagSet:   fs,
		UsageFunc: shared.DefaultUsageFunc,
		Exec: func(ctx context.Context, args []string) error {
			if *submit && !*confirm {
