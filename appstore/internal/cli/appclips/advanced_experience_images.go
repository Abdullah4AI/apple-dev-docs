...
func AppClipAdvancedExperienceImagesCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "images",
		ShortUsage: "appstore app-clips advanced-experiences images <subcommand> [flags]",
		ShortHelp:  "Manage App Clip advanced experience images.",
		LongHelp: `Manage App Clip advanced experience images.

Examples:
  appstore app-clips advanced-experiences images get --id "IMAGE_ID"
  appstore app-clips advanced-experiences images create --experience-id "EXP_ID" --file path/to/image.png
  appstore app-clips advanced-experiences images delete --id "IMAGE_ID" --confirm`,
		FlagSet:   fs,
...
func AppClipAdvancedExperienceImagesGetCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "get",
		ShortUsage: "appstore app-clips advanced-experiences images get --id \"IMAGE_ID\"",
...
func AppClipAdvancedExperienceImagesCreateCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "create",
		ShortUsage: "appstore app-clips advanced-experiences images create --experience-id \"EXP_ID\" --file path/to/image.png",
...
func AppClipAdvancedExperienceImagesDeleteCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "delete",
		ShortUsage: "appstore app-clips advanced-experiences images delete --id \"IMAGE_ID\" --confirm",
