...
func IAPPricePointsCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "price-points",
		ShortUsage: "appstore iap price-points <subcommand> [flags]",
...
Examples:
  ...
  appstore iap price-points equalizations --id "PRICE_POINT_ID"`,
		FlagSet:   fs,
...
func IAPPricePointsListCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "list",
		ShortUsage: "appstore iap price-points list --iap-id \"IAP_ID\"",
		ShortHelp:  "List price points for an in-app purchase.",
		LongHelp: `List price points for an in-app purchase.

Examples:
  appstore iap price-points list --iap-id "IAP_ID"
  appstore iap price-points list --iap-id "IAP_ID" --territory "USA"
  appstore iap price-points list --iap-id "IAP_ID" --paginate`,
		FlagSet:   fs,
		UsageFunc: shared.DefaultUsageFunc,
		Exec: func(ctx context.Context, args []string) error {
...
func IAPPricePointsEqualizationsCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "equalizations",
		ShortUsage: "appstore iap price-points equalizations --id \"PRICE_POINT_ID\"",
