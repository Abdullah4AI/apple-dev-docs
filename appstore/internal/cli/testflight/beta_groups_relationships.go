...
func BetaGroupsRelationshipsCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "relationships",
		ShortUsage: "appstore testflight beta-groups relationships <subcommand> [flags]",
		ShortHelp:  "View beta group relationship linkages.",
		LongHelp: `View beta group relationship linkages.

Examples:
  appstore testflight beta-groups relationships get --group-id "GROUP_ID" --type "betaTesters"
  appstore testflight beta-groups relationships get --group-id "GROUP_ID" --type "builds" --paginate`,
		FlagSet:   fs,
...
func BetaGroupsRelationshipsGetCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "get",
		ShortUsage: "appstore testflight beta-groups relationships get --group-id \"GROUP_ID\" --type \"RELATIONSHIP\" [flags]",
