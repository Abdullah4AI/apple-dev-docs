...
// Keeps the existing appstore device slugs while delegating rendering to Koubou frame names.
...
func createDefaultKoubouConfig(
	...
	workDir, err := os.MkdirTemp("", "appstore-shots-*")
	if err != nil {
