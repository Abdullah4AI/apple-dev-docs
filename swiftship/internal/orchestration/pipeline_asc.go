...
`)
	...
	ascSkills := []struct {
		...
		{"skills/asc-cli-usage", "CLI Usage"},
		{"skills/asc-xcode-build", "Xcode Build and Export"},
		{"skills/asc-build-lifecycle", "Build Lifecycle"},
		{"skills/asc-signing-setup", "Signing Setup"},
		{"skills/asc-testflight-orchestration", "Release and TestFlight Orchestration"},
		{"skills/asc-id-resolver", "ID Resolution"},
		{"skills/asc-submission-health", "Submission Health"},
		{"skills/asc-metadata-sync", "Metadata Sync and Localization"},
		{"skills/asc-shots-pipeline", "Screenshot Pipeline"},
		{"skills/asc-app-create-ui", "App Creation"},
		{"skills/asc-crash-triage", "Crash Triage"},
		{"skills/asc-notarization", "macOS Notarization"},
		{"skills/asc-ppp-pricing", "PPP Pricing"},
		{"skills/asc-revenuecat-catalog-sync", "RevenueCat Catalog Sync"},
		{"skills/asc-subscription-localization", "Subscription Localization"},
		{"skills/asc-wall-submit", "Wall of Apps"},
		{"skills/asc-workflow", "Workflow Automation"},
		// Nanowave-specific skills
		{"skills/asc-publish", "App Store Publishing"},
		{"skills/asset-management", "Asset Management"},
		{"skills/asc-hitl-interaction", "User Interaction Patterns"},
		{"skills/asc-screenshot-upload", "Screenshot Upload"},
		{"skills/asc-manual-actions", "Manual Actions and Dashboard Tasks"},
		{"skills/asc-submission-prereqs", "Submission Prerequisites"},
		{"skills/asc-version-routing", "Version State Routing"},
	}
	loadedCount := 0
